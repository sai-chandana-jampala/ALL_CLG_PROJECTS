...
package_name = 'mobile_arm_gripper_spawner_pkg'
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name,'models/small_gripper/'), glob('./models/small_gripper/*')),

        # Path to the mobile robot sdf file
        (os.path.join('share', package_name,'models/mobile_arm_gripper/'), glob('./models/mobile_arm_gripper/*')),
    ...
    entry_points={
        'console_scripts': [
          'spawn_demo = mobile_arm_gripper_spawner_pkg.spawn_demo:main'
        ],
    },
)
